...
import {fetchname, fetchusername} from '@/actions/userActions'
...
const page = () => {
    ...
    useEffect(() => {
        ...
        if (session) {
            fetchname(session.user.email).then((name)=>{
                if(name){
                    fetchusername(session.user.email).then((username)=>{
    ...
    return (
        <div className='text-white text-center py-16 mx-auto'>
            <h1 className='text-3xl'>Login to get started</h1>

            <div className="flex flex-col gap-2 p-10 items-center">


                <button
                    className="flex w-60 items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                ...
                <button
                    onClick={()=>signIn("github")} className="flex w-60 items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
